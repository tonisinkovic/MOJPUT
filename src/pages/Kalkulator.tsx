          ...
          >
            ...
            <div className="grid lg:grid-cols-5 gap-6 lg:gap-8">
              ...
              >
                ...
                >
                  <CardHeader className="space-y-1 pb-3 max-lg:p-3 max-lg:pb-2">
                  ...
                  <CardContent className="space-y-4 max-lg:space-y-3 max-lg:px-3 max-lg:pb-3">
                    ...
                    {activeFilterCount > 0 && (
                      <div className="flex items-center justify-between gap-2 rounded-lg border border-primary/10 bg-primary/5 px-2 py-1.5 sm:px-3 sm:py-2">
                        <span className="min-w-0 text-[11px] leading-snug text-muted-foreground sm:text-xs">
                          {preFilteredPrograms.length} programa
                        ...
                        <button
                          ...
                          className="inline-flex shrink-0 items-center gap-0.5 text-[11px] text-muted-foreground transition-colors hover:text-foreground sm:gap-1 sm:text-xs"
                        >
                          <X className="h-3 w-3" />
                          Očisti
                        </button>
                    ...
                    <Popover open={facultyOpen} onOpenChange={setFacultyOpen}>
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          className="h-12 w-full min-w-0 justify-between rounded-xl border-2 border-input bg-background font-normal shadow-sm transition-all hover:border-primary/30 hover:bg-muted/30 max-lg:h-10 max-lg:rounded-lg max-lg:px-2.5 max-lg:text-sm"
                        >
                          {selectedProgram ? (
                          ...
                          <ChevronsUpDown className="ml-1.5 h-3.5 w-3.5 shrink-0 opacity-50 sm:ml-2 sm:h-4 sm:w-4" />
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent
                    ...
                    {selectedFormula && (
                      <motion.div
                        ...
                        className={cn(
                          "flex items-start gap-1.5 rounded-lg border p-2 sm:gap-2 sm:rounded-xl sm:p-3",
                          selectedFormula.izvor === "tocna_formula"
                            ? "bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800"
                            : "bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800"
                        )}
                      >
                        <Info className={cn("mt-0.5 h-3.5 w-3.5 shrink-0 sm:h-4 sm:w-4", selectedFormula.izvor === "tocna_formula" ? "text-emerald-600" : "text-blue-600")} />
                        <div className="min-w-0 text-xs sm:text-sm">
                          <p className={cn("font-medium leading-snug", selectedFormula.izvor === "tocna_formula" ? "text-emerald-700 dark:text-emerald-400" : "text-blue-700 dark:text-blue-400")}>
                            {selectedFormula.izvor === "tocna_formula"
                              ? "Verificirana formula bodovanja"
                              : `Formula za tip: ${selectedFormula.kategorija ?? "opći"}`}
                          </p>
                          {selectedFormula.napomena && (
                            <p className="mt-1 text-[11px] italic leading-snug text-muted-foreground sm:text-sm">
                              {selectedFormula.napomena}
                            </p>
                          )}
                        </div>
