          ...
          >
            ...
            <div className="rounded-xl border-2 border-border bg-card p-3 shadow-card sm:rounded-2xl sm:p-5 md:p-6">
              ...
              <div className="relative">
                ...
                <ol className="relative grid grid-cols-5 gap-0 px-0.5 sm:gap-2 sm:px-0">
                  {WIZARD_STEPS.map((s) => {
                    ...
                    <Popover open={facultyOpen} onOpenChange={setFacultyOpen}>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          <ChevronsUpDown className="ml-1.5 h-3.5 w-3.5 shrink-0 opacity-50 max-lg:mt-0.5 sm:ml-2 sm:h-4 sm:w-4" />
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent
                    ...
                    {wizardStep === 3 && selectedFormula?.natjecanja && selectedFormula.natjecanja.length > 0 && (
                      <Card className={cn(cardShell, "border-amber-200 dark:border-amber-800")}>
                        <CardHeader className="pb-3">
                          ...
                          <CardDescription>
                            Kako se vrednuju (ne unosi se u kalkulator — provjeri na fakultetu)
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2">
