...
const Kviz = () => {
  return (
    <Layout>
      <section className="relative mx-auto min-h-[70vh] max-w-4xl px-3 pb-10 pt-6 sm:px-4 sm:pb-12 sm:pt-8 md:py-14 md:pb-16 [padding-bottom:max(2.5rem,env(safe-area-inset-bottom))]">
        <div
          aria-hidden
